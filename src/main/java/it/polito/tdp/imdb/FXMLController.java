...
public class FXMLController {
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	boxRegista.getItems().addAll(model.listaRegisti());
    }

    @FXML
    void doRegistiAdiacenti(ActionEvent event) {
    	txtResult.setText(model.adiacenti(boxRegista.getValue()).toString());
    }

    @FXML
    void doRicorsione(ActionEvent event) {
    	txtResult.setText(model.percorso(boxRegista.getValue(), Integer.parseInt(txtAttoriCondivisi.getText())).toString());
    }
